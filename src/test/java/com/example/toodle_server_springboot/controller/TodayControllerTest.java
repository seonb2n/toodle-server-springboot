...
class TodayControllerTest {
    ...
    TodayControllerTest(@Autowired MockMvc mvc) {
        this.mvc = mvc;
    }
    ...
    public void givenUserAccount_whenGetToday_thenReturnTodayResponse() throws Exception {
        ...
        PostItDto postItDto = PostItDto.of(UUID.randomUUID(), null, "postit-content", LocalDateTime.now(), false);
