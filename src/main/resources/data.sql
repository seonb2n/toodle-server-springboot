...
values ('02e4dd01-a94a-4bd1-9069-7b3fdfee04fe', 'ac448216-995f-4e0f-b5d7-cb9a2967d3ba', now(), 'sbkim', now(), 'sbkim', '운동', false, 1);

insert into tb_postit_category (postit_category_id, postit_category_client_id, created_at, created_by, modified_at, modified_by, postit_category_title, deleted, user_id)
values ('bd8e27f9-d5d5-4d7f-87c0-ec474828145f', '5d7a8bda-c988-44a5-b965-90a768e6f040', now(), 'sbkim', now(), 'sbkim', '생필품', false, 1);
...
values ('862f028c-8094-4f8b-a275-cd8c4e3a75e9', '1e20bfaa-98c6-487f-b761-4aa6d522b02a', now(), 'sbkim', now(), 'sbkim', '하체 운동하기!', false, 1, '02e4dd01-a94a-4bd1-9069-7b3fdfee04fe');

insert into tb_postit (postit_id, postit_client_id, created_at, created_by, modified_at, modified_by, postit_content, postit_is_done, user_id, postit_category_id)
values ('44240e8a-eaab-4a8f-831a-87a7e8fdc0b6', 'b6b703a3-1646-4d9a-9c40-3ee6f2bf8806', now(), 'sbkim', now(), 'sbkim', '저녁 식재료 사기!', false, 1, 'bd8e27f9-d5d5-4d7f-87c0-ec474828145f');
