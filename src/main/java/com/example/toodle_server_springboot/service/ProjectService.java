...
public class ProjectService {
        ...
        projectDto.taskDtoSet()
            ...
            if (originalTaskOptional.isEmpty()) {
                ...
                taskDto.actionDtoSet().forEach(actionDto -> {
                    Optional<Action> originalActionOptional = actionRepository.findById(actionDto.actionId());
                    if (originalActionOptional.isEmpty()) {
                        ...
                        savedAction.update(actionDto.content(), actionDto.dueDate(), actionDto.isDone());
                    }
                });
    ...
    public Action registerAction(UserAccount userAccount, Task task, ActionDto actionDto) {
        Action action = Action.of(userAccount, task, actionDto.content(), actionDto.dueDate(), actionDto.isDone());
