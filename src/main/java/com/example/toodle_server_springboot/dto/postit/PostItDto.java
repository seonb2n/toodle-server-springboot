...
public record PostItDto(
    ...
    public static PostItDto of(PostItCategoryDto categoryDto, String content, boolean isDone) {
        return new PostItDto(null, categoryDto, content,
            LocalDateTime.now().format(DATE_TIME_FORMATTER), isDone);
    }

    public static PostItDto of(UUID postItId, PostItCategoryDto categoryDto, String content,
        LocalDateTime createdTime, boolean isDone) {
        return new PostItDto(postItId, categoryDto, content,
            createdTime.format(DATE_TIME_FORMATTER), isDone);
    }
