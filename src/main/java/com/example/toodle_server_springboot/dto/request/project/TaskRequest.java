...
public record TaskRequest(
    ...
    public static TaskRequest of(String uuid, String content, String importance,
        LocalDateTime startAt, LocalDateTime endAt, List<ActionRequest> actionRequestList) {
    ...
    public TaskDto toDto(UserAccountDto userAccountDto) {
        return TaskDto.of(
            ...
            endAt,
            actionDtoSet.stream()
                .map(actionRequest -> actionRequest.toDto(userAccountDto))
