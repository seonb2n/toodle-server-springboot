...
public record ActionDto(
    ...
    public static ActionDto of(UUID actionId, UserAccountDto userAccountDto, String content,
        LocalDateTime dueDate, boolean isDone) {
        return new ActionDto(actionId, userAccountDto, content, dueDate, isDone);
    }

    public static ActionDto of(UserAccountDto userAccountDto, String content, LocalDateTime dueDate,
        boolean isDone) {
