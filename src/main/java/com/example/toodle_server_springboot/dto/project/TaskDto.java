...
public record TaskDto(
    ...
    public static TaskDto of(UUID taskId, UserAccountDto userAccountDto, String content,
        String importance, LocalDateTime startAt, LocalDateTime endAt,
        Set<ActionDto> actionDtoSet) {
        return new TaskDto(taskId, userAccountDto, content, importance, startAt, endAt,
            actionDtoSet);
    }
